    ...
    <div class="relative z-10 mx-auto max-w-7xl space-y-14 px-4 sm:px-6 lg:px-8">
      <div class="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        ...
        <div class="grid gap-4 md:grid-cols-3">
          <div
            v-for="item in tryoutHighlights"
            :key="item.title"
          ...
          >
            ...
            <h3 class="mt-4 text-2xl font-black" :class="item.accent">{{ item.title }}</h3>
      ...
      <div class="grid gap-6 lg:grid-cols-2">
        <a
          v-for="platform in tryoutPlatforms"
          :key="platform.slug"
          :href="platform.url"
          target="_blank"
          rel="noreferrer"
          class="group rounded-[2rem] border p-7 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl"
        ...
        >
          ...
          <div class="mt-6 grid gap-3 md:grid-cols-3">
            ...
            <div
              v-for="point in platform.points.slice(0, 2)"
              :key="point"
