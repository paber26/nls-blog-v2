<footer id="kontak" class="bg-slate-900 pt-10 pb-10 text-slate-300 relative overflow-hidden">
    <!-- Decorative -->
    <div class="absolute inset-0 bg-gradient-to-b from-transparent to-black/20 pointer-events-none"></div>
    <div class="absolute bottom-0 right-0 w-96 h-96 bg-brand-light/10 rounded-full blur-3xl pointer-events-none translate-y-1/2 translate-x-1/2"></div>
    
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        <div class="col-span-1 lg:col-span-2 space-y-6 pr-0 lg:pr-12">
          <div class="flex items-center gap-3">
            <img
              src="/nls-logo-300.png"
              alt="Logo Next Level Study"
              class="h-12 w-12 rounded-xl object-cover shadow-lg"
            />
            <div class="flex flex-col">
              <span class="font-heading font-black text-2xl text-white tracking-tight leading-none">Next Level</span>
          ...
          <div class="flex space-x-4">
            <button type="button" title="Instagram akan segera tersedia" class="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-300/70 cursor-default">
      ...
      <div class="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-slate-500">
        ...
        <div class="flex items-center gap-4">
          ...
          <span>&middot;</span>
          <a href="/privacy" class="hover:text-white transition-colors">Kebijakan Privasi</a>
        </div>
      </div>
    </div>
  </footer>
