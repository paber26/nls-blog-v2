<section id="tentang" class="py-24 bg-white relative overflow-hidden">
    <!-- Decorative -->
    <div class="absolute right-0 top-1/2 -translate-y-1/2 translates-x-1/2 w-96 h-96 bg-brand-light/5 rounded-full blur-3xl pointer-events-none"></div>
    
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <!-- Text Content -->
        <div class="space-y-6">
          <div class="inline-block px-4 py-1.5 rounded-full bg-indigo-50 text-indigo-600 font-semibold text-sm tracking-wide mb-2 uppercase border border-indigo-100">
            Tentang NLS
          </div>
          ...
          <ul class="space-y-5 pt-4">
            <li class="flex items-start gap-4">
              <div class="w-12 h-12 rounded-2xl bg-green-100 border border-green-200 flex items-center justify-center flex-shrink-0 mt-0.5 shadow-sm">
            ...
            <li class="flex items-start gap-4">
              <div class="w-12 h-12 rounded-2xl bg-blue-100 border border-blue-200 flex items-center justify-center flex-shrink-0 mt-0.5 shadow-sm">
        ...
        <div class="relative mt-8 lg:mt-0">
          ...
          <div class="relative bg-surface-container-low w-full aspect-square md:aspect-[4/3] rounded-3xl shadow-2xl overflow-hidden border-4 border-white group">
            ...
            <div class="absolute inset-x-0 bottom-0 p-8 z-20 text-white">
              <h3 class="text-2xl font-bold mb-2 font-heading truncate">Tim Profesional NLS</h3>
              <p class="text-white/90 text-sm line-clamp-2">Didedikasikan membimbing mencapai prestasi tertinggi dengan metode Next Level.</p>
            </div>
          </div>
        </div>
      </div>
