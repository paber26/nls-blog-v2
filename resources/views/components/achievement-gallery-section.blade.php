    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 lg:grid-cols-[0.85fr_1.15fr] gap-10 items-start">
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="rounded-[1.5rem] bg-brand-surface p-5 shadow-lg shadow-slate-200/40">
              ...
              <p class="mt-2 text-sm leading-relaxed text-on-surface-variant">Foto kegiatan dan capaian yang memperlihatkan rekam jejak NLS.</p>
            </div>
            <div class="rounded-[1.5rem] bg-brand-surface p-5 shadow-lg shadow-slate-200/40">
              ...
              <p class="mt-2 text-sm leading-relaxed text-on-surface-variant">Membantu kamu melihat aktivitas dan capaian NLS secara lebih nyata.</p>
            </div>
            <div class="rounded-[1.5rem] bg-brand-surface p-5 shadow-lg shadow-slate-200/40">
              ...
              <p class="mt-2 text-sm leading-relaxed text-on-surface-variant">Cocok dijadikan referensi saat kamu ingin mengenal layanan atau kerja sama NLS.</p>
            </div>
          </div>
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              class="inline-flex items-center justify-center rounded-full border border-outline-variant px-6 py-3 font-semibold text-on-surface transition-colors hover:border-brand-light hover:text-brand-blue"
            >
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <article
            class="group overflow-hidden rounded-[1.75rem] border border-outline-variant bg-brand-surface shadow-lg shadow-slate-200/40 transition-all hover:-translate-y-2 hover:shadow-2xl"
          >
            <div class="relative overflow-hidden">
              ...
              <div class="absolute left-4 top-4 rounded-full bg-white/90 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-on-surface">
                {{ $item['category'] }}
              </div>
            </div>
            <div class="p-5 space-y-2">
              <h3 class="text-xl font-bold text-slate-900">{{ $item['title'] }}</h3>
              <p class="text-sm leading-relaxed text-on-surface-variant">{{ $item['caption'] }}</p>
            </div>
          </article>
          @endforeach
        </div>
