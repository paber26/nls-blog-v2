...
<main class="bg-brand-surface pt-10 pb-24">
    <article class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <a href="/articles" class="inline-flex items-center gap-2 text-sm font-semibold text-slate-500 hover:text-brand-blue mb-8 transition-colors">
      ...
      <div class="bg-white rounded-3xl p-8 border border-slate-100 shadow-xl shadow-slate-200/40 text-center">
        <h3 class="text-2xl font-bold text-slate-900 mb-3">Punya Pertanyaan?</h3>
        <p class="text-slate-600 mb-6 max-w-md mx-auto">Konsultasikan kebutuhan belajarmu dengan tim ahli NLS sekarang juga.</p>
