...
<main class="bg-brand-surface py-20 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <a href="/articles/{{ $article->slug }}" class="group bg-white rounded-3xl overflow-hidden shadow-xl shadow-slate-200/40 border border-slate-100 flex flex-col hover:-translate-y-2 transition-all duration-300">
          ...
          <div class="p-8 flex flex-col flex-grow">
            <h3 class="text-xl font-bold font-heading text-slate-800 mb-4 group-hover:text-brand-light transition-colors leading-snug">
              {{ $article->title }}
            </h3>
            <p class="text-slate-600 mb-6 text-sm line-clamp-3 leading-relaxed">
              {{ $article->summary }}
            </p>
